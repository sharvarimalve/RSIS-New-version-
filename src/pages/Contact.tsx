  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="flex items-center justify-center px-4 sm:px-6 py-12 sm:py-16">
        <div
          className="max-w-6xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-2 transform transition duration-500 hover:scale-[1.02]"
          data-aos="zoom-in"
        >
          {/* Left Side - Form */}
