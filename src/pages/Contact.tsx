  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="flex items-center justify-center px-4 sm:px-6 py-12 sm:py-16">
        <div className="max-w-6xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 md:grid-cols-2 transform transition duration-500 hover:scale-[1.02]">
          {/* Left Side - Form */}
          <div className="p-6 sm:p-12 flex flex-col justify-center relative">
            ...
            <form className="space-y-6 sm:space-y-8">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Name"
                  className="w-full pl-10 pr-4 py-3 sm:py-4 rounded-lg border border-gray-200 shadow-inner focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-700"
                />
              </div>
              ...
              <div className="relative">
                ...
                <textarea
                  rows={5}
                  placeholder="Message"
                  className="w-full pl-10 pr-4 py-3 sm:py-4 rounded-lg border border-gray-200 shadow-inner focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-700 resize-none"
                />
              </div>

              <button
                type="submit"
                className="w-full bg-[#001F54] text-white font-semibold py-3 sm:py-4 rounded-lg shadow-lg hover:shadow-xl transition-transform transform hover:-translate-y-0.5 text-base sm:text-lg"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="hidden md:flex items-center justify-center bg-gradient-to-tr from-blue-100 to-blue-50 relative">
            <img
              src="/contact2.jpg"
      ...
      <section className="relative mx-4 sm:mx-8 lg:mx-20 bg-[#001F54] rounded-2xl py-10 px-6 sm:px-10 overflow-visible">
        <div className="container mx-auto flex flex-col lg:flex-row items-center gap-8">
          ...
          <div className="relative w-full lg:w-1/2 flex justify-center h-56 sm:h-60 lg:h-72">
            <img
