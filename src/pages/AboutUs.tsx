      ...
      <section className="relative py-8 sm:py-12 bg-[#001F54] rounded-2xl">
        <div className="container mx-auto flex flex-col lg:flex-row items-center gap-8 px-4">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left text-white">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4">Need a reliable website partner for your business?</h2>
            <p className="mb-6 text-sm sm:text-base">
              For the very best in web design, branding, and digital marketing, call <strong>Right Serve Infotech System</strong> at{" "}
              <a href="tel:6302966932" className="text-cyan-300 hover:text-cyan-200 font-semibold">(630) 296-6932</a>.
            </p>
            <a href="/contact">
